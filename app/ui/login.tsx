    ...
    return (
      <div className="px-10 mx-5 py-6 bg-white shadow-md flex flex-col gap-3 items-center">
          ...
          <form action="" className='mt-5 w-full sm:w-72' onSubmit={handleFormSubmit}>
              ...
              <button className='py-2 w-full flex items-center justify-center bg-black text-white cursor-pointer hover:bg-gray-800  transition-all duration-200'>{ loading ? <CircleSpinner /> : "Se connecter " }</button>
          </form>
      </div>
  )
}
